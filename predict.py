...
def predict(model, X_test, Y_test):
    ...
    plt.imshow(img1, cmap=plt.cm.binary).axes.get_xaxis().set_visible(False)
    plt.subplot(4, 2, 2)
    plt.title("Input: 128x128")
    plt.imshow(img2, cmap=plt.cm.binary).axes.get_xaxis().set_visible(False)
    ...
    plt.imshow(init1, cmap=plt.cm.binary).axes.get_xaxis().set_visible(False)
    plt.subplot(4, 2, 8)
    plt.title("HR version: 512x512")
    plt.imshow(init2, cmap=plt.cm.binary).axes.get_xaxis().set_visible(False)
